...
using namespace std;
	...
	/**
	* Ce constructeur par défaut initialise les attributs aux valeurs par défaut.
	*/
	Plat::Plat() { 
		nom_ = "inconnu";
		prix_ = 0;
	...
	/**
	* Ce constructeur par paramètres initialise les attributs aux valeurs correspondantes.
	*/
